...
public class MicuentaPDF implements Task{
	
	private PageObject page;

	public MicuentaPDF(PageObject page) {
		this.page = page;
	}
	@Override
	...
	public static MicuentaPDF descargar(PageObject page) {
		return Tasks.instrumented(MicuentaPDF.class,page);
